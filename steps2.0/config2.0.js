module.exports = {
  ...
  selectors: {
    ...
    entitiesGrid: '#grid_1781639624_2',
    entitiesAddButton: '#grid_1781639624_2 div.e-toolbar-item button[aria-label="Add"]',
    mainSaveButton: 'button.submit-button:has-text("Save")',
    entitiesModalAddButton: 'button[title="Add Entity"]',
    entitiesAddButton: '.e-accordion .e-toolbar-item button.e-tbar-btn:has-text("Add")',
    entitiesAccordionHeader: 'div.e-acrdn-header:has-text("Entities")',
  },
  timeouts: {
